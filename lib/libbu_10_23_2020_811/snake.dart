...
class SnakeBoardPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final Paint blackLine = Paint()..color = GameState.g_theme_color;
...
class SnakeState extends State<Snake> {
  ...
  void _step() {
    ...
    GameState.head_pt.x == columns -1  ||
      ...
      GameState.reset_game(_streamSubscription);
GameState.game_over = true;
      Navigator.push(
          context,
...
static String input_setting="Touch";
static Color g_theme_color = Colors.deepPurple;
  ...
  static void reset_game(sub_to_cancel){
    step_count = 0;
    snakeLength = 5;
    foods_captured = 0;
    show_food_exp = false;
